...
func TestParseTemplateParalyzing(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "default",
			raw:  "{{Paralyzing}}",
			want: &dataset.Enchantment{Name: "Paralyzing", Amount: "17", BonusType: "On-hit", Notes: notes("Will", "17")},
		},
		{
			name: "regular",
			raw:  "{{Paralyzing|Regular}}",
			want: &dataset.Enchantment{Name: "Regular Paralyzing", Amount: "17", BonusType: "On-hit", Notes: notes("Will", "17")},
		},
		{
			name: "improved",
			raw:  "{{Paralyzing|Improved}}",
			want: &dataset.Enchantment{Name: "Improved Paralyzing", Amount: "25", BonusType: "On-hit", Notes: notes("Will", "25")},
		},
		{
			name: "legendary",
			raw:  "{{Paralyzing|Legendary}}",
			want: &dataset.Enchantment{Name: "Legendary Paralyzing", Amount: "100", BonusType: "On-hit", Notes: notes("Fortitude", "100")},
		},
		{
			name: "default with custom DC",
			raw:  "{{Paralyzing||117}}",
			want: &dataset.Enchantment{Name: "Paralyzing +117", Amount: "117", BonusType: "On-hit", Notes: notes("Will", "117")},
		},
		{
			name: "improved with custom DC",
			raw:  "{{Paralyzing|Improved|45}}",
			want: &dataset.Enchantment{Name: "Improved Paralyzing +45", Amount: "45", BonusType: "On-hit", Notes: notes("Will", "45")},
		},
		{
			name: "legendary with custom DC",
			raw:  "{{Paralyzing|Legendary|150}}",
			want: &dataset.Enchantment{Name: "Legendary Paralyzing +150", Amount: "150", BonusType: "On-hit", Notes: notes("Fortitude", "150")},
		},
		{
			name: "switch is case insensitive",
			raw:  "{{Paralyzing|legendary| 125 }}",
			want: &dataset.Enchantment{Name: "legendary Paralyzing +125", Amount: "125", BonusType: "On-hit", Notes: notes("Fortitude", "125")},
		},
		{
			name: "unknown version uses default save",
			raw:  "{{Paralyzing|Other}}",
			want: &dataset.Enchantment{Name: "Other Paralyzing", Amount: "17", BonusType: "On-hit", Notes: notes("Will", "17")},
		},
	}
...
func TestParseTemplatePoisonNightshadeVenomNew(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: &dataset.Enchantment{Name: "Nightshade Venom +45", Notes: new(notes)},
		},
		{
			name: "switch is case insensitive",
			raw:  "{{Poison|NIGHTSHADE VENOM NEW||| 45 }}",
		...
		},
		{
			...
			want: &dataset.Enchantment{Name: "Sinister Nightshade", Notes: new(notes)},
		},
	}
