...
func parseTemplateOrbBonus(rawOrbValue string) []*dataset.Enchantment {
...
func parseTemplateOffensiveEffect(rawOEValue string) *dataset.Enchantment {
...
func parseTemplateOoze(raw string) *dataset.Enchantment {
	const prefix = "{{Ooze"
	const suffix = "}}"
...
func parseTemplateNightmares(raw string) *dataset.Enchantment {
...
func parseTemplateNullmagicGuard(raw string) *dataset.Enchantment {
...
func parseTemplateNightmareGuard(raw string) *dataset.Enchantment {
...
func parseTemplateOverfocus(raw string) []*dataset.Enchantment {
...
func parseTemplateNimbleness(raw string) *dataset.Enchantment {
...
func parseTemplateNearlyFinished() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateNearlyComplete(raw string) *dataset.Enchantment {
...
func parseTemplateNightsinger() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Nightsinger",
...
func parseTemplateOverwhelmingDespair(raw string) *dataset.Enchantment {
...
func parseTemplateNegation(raw string) *dataset.Enchantment {
...
func parseTemplateOccasionalOvercooling() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateOrlassksPrison() *dataset.Enchantment {
	return &dataset.Enchantment{
