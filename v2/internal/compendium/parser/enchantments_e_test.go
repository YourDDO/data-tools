...
func TestParseTemplateElementalAbsorb(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: []*dataset.Enchantment{{Name: "Fire Absorption", Amount: "5%", BonusType: "Enhancement", Element: "Fire"}},
		},
		{
			name: "electricity is normalized",
			raw:  "{{ElementalAbsorb|Electricity|20||Quality}}",
			want: []*dataset.Enchantment{{Name: "Electric Absorption", Amount: "20%", BonusType: "Quality", Element: "Electric"}},
		},
		{
			name: "custom title",
			raw:  "{{ElementalAbsorb|Negative Energy|20|Negative Ward|Insight}}",
			want: []*dataset.Enchantment{{Name: "Negative Ward", Amount: "20%", BonusType: "Insight", Element: "Negative Energy"}},
		},
		{
		...
		},
		{
			...
			want: []*dataset.Enchantment{{Name: "Fire Absorption", Amount: "19%", BonusType: "Enhancement", Element: "Fire"}},
		},
		{
			name: "legendary chitinous has a fixed amount",
			raw:  "{{ElementalAbsorb|Legendary Chitinous|||Quality}}",
			want: []*dataset.Enchantment{{Name: "Fire Absorption", Amount: "34%", BonusType: "Quality", Element: "Fire"}},
		},
		{
			name: "hound's bones",
...
func TestParseTemplateEfficientMetamagic(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: &dataset.Enchantment{Name: "Embolden Spell (Cost Reduction)", Amount: "4", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Empower Healing uses the standard reduction scale",
			raw:  "{{EfficientMetamagic|Empower Healing|II}}",
			want: &dataset.Enchantment{Name: "Empower Healing Spell (Cost Reduction)", Amount: "2", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Empower uses the standard reduction scale",
			raw:  "{{EfficientMetamagic|Empower|III}}",
			want: &dataset.Enchantment{Name: "Empower Spell (Cost Reduction)", Amount: "3", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Enlarge uses the standard reduction scale",
			raw:  "{{EfficientMetamagic|Enlarge|I}}",
			want: &dataset.Enchantment{Name: "Enlarge Spell (Cost Reduction)", Amount: "1", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Extend uses the standard reduction scale",
			raw:  "{{EfficientMetamagic|Extend|IV}}",
			want: &dataset.Enchantment{Name: "Extend Spell (Cost Reduction)", Amount: "4", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Intensify uses the standard reduction scale",
			raw:  "{{EfficientMetamagic|Intensify|II}}",
			want: &dataset.Enchantment{Name: "Intensify Spell (Cost Reduction)", Amount: "2", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Maximize uses the doubled reduction scale",
			raw:  "{{EfficientMetamagic|Maximize|III}}",
			want: &dataset.Enchantment{Name: "Maximize Spell (Cost Reduction)", Amount: "6", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "Quicken uses the doubled reduction scale and lowercase magnitude",
			raw:  "{{EfficientMetamagic|Quicken|iv}}",
			want: &dataset.Enchantment{Name: "Quicken Spell (Cost Reduction)", Amount: "8", BonusType: "Enhancement", Notes: new("")},
		},
		{
			name: "custom title and info",
			raw:  "{{EfficientMetamagic|Maximize|II|Custom Efficiency|From an upgrade.}}",
			want: &dataset.Enchantment{Name: "Custom Efficiency", Amount: "4", BonusType: "Enhancement", Notes: new("From an upgrade.")},
		},
		{
