...
func parseTemplateBottledHeart() []*dataset.Enchantment {
...
func parseTemplateBluntTrama() *dataset.Enchantment {
...
func parseTemplateBane(rawBaneValue string) *dataset.Enchantment {
	const prefix = "{{Bane|"
	const suffix = "}}"
...
func parseTemplateBodyfeeder(raw string) *dataset.Enchantment {
...
func parseTemplateBoonofUndeath(raw string) *dataset.Enchantment {
...
func parseTemplateBlackAbbotItemUpgrade(raw string) *dataset.Enchantment {
...
func parseTemplateBanishing(raw string) *dataset.Enchantment {
...
func parseTemplateBrillianceGuard(raw string) *dataset.Enchantment {
...
func parseTemplateBlood() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Blood",
...
func parseTemplateBlackscaleFerocity() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateBloodyThorns() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Bloody Thorns",
...
func parseTemplateBattleScarred() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Battle-Scarred",
...
func parseTemplateBrazenBrilliance(raw string) *dataset.Enchantment {
...
func parseTemplateBleed(raw string) *dataset.Enchantment {
	const prefix = "{{Bleed"
	const suffix = "}}"
...
func parseTemplateBloodletter(raw string) *dataset.Enchantment {
...
func parseTemplateBlindingFlash(raw string) *dataset.Enchantment {
...
func parseTemplateBlindingEmbers(raw string) *dataset.Enchantment {
...
func parseTemplateBrillanceoftheShatteredSun(raw string) *dataset.Enchantment {
...
func parseTemplateBonesplitter(raw string) *dataset.Enchantment {
...
func parseTemplateBoneshatter(raw string) *dataset.Enchantment {
...
func parseTemplateBetterOffhanded(raw string) *dataset.Enchantment {
...
func parseTemplateBoneBreaking() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Bone Breaking",
...
func parseTemplateBaneOfTheDepths() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateBlinding() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Blinding",
...
func parseTemplateBlindingFear() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Blinding Fear",
...
func parseTemplateBlockElements(fullTemplate string) *dataset.Enchantment {
