...
func parseTemplateJetPropulsion(rawJetValue string) *dataset.Enchantment {
...
func parseTemplateLegendaryGreenSteel() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateLitanyAbilityBonus(raw string) []*dataset.Enchantment {
	...
	out := make([]*dataset.Enchantment, 0, len(abilities))
...
func parseTemplateLimbChopper() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:      "Limb Chopper",
		BonusType: "On-vorpal",
...
func parseTemplateKeen(raw string) *dataset.Enchantment {
	const prefix = "{{Keen"
	const suffix = "}}"
...
func parseTemplateLinguistics(raw string) []*dataset.Enchantment {
...
func parseTemplateLitanyCombatBonus(raw string) []*dataset.Enchantment {
...
// Usage: {{LostPurpose}}
func parseTemplateLostPurpose(raw string) *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Lost Purpose",
...
func parseTemplateLifeShield(raw string) *dataset.Enchantment {
...
func parseTemplateKickEmWhileTheyreDown(raw string) *dataset.Enchantment {
...
func parseTemplateLightningGuard(raw string) *dataset.Enchantment {
...
func parseTemplateLifesealed(raw string) []*dataset.Enchantment {
...
func parseTemplateLightningStormGuard(raw string) *dataset.Enchantment {
...
func parseTemplateLightningStrike(raw string) *dataset.Enchantment {
...
func parseTemplateLifeStealing(raw string) *dataset.Enchantment {
...
func parseTemplateLifedrinker(raw string) *dataset.Enchantment {
...
func parseTemplateLightsOut() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Lights Out",
...
func parseTemplateKneeCracker() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Knee Cracker",
