...
func parseTemplateSkill(rawSkillValue string) *dataset.Enchantment {
	const prefix = "{{Skill|"
	const suffix = "}}"
...
func parseTemplateSheltering(rawShelteringValue string) []*dataset.Enchantment {
	...
	var output []*dataset.Enchantment
	...
	if strings.ToLower(rating) == "both" {
		output = append(output, &dataset.Enchantment{
...
func parseTemplateSeeker(rawSeekerValue string) []*dataset.Enchantment {
	const prefix = "{{Seeker|"
	const suffix = "}}"
	const defaultBonusType = "Enhancement" // Default from documentation
...
func parseTemplateSkillGroupBonus(rawSGBValue string) []*dataset.Enchantment {
...
func parseTemplateShockwave(rawSWValue string) *dataset.Enchantment {
...
func parseTemplateSealedInMist() *dataset.Enchantment {
...
func parseTemplateSealedInFire() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name: "Sealed in Fire",
		// All other fields remain empty.
	}
...
func parseTemplateShadowStriker() []*dataset.Enchantment {
	return []*dataset.Enchantment{
		{ // Doublestrike
...
func parseTemplateSealedInGloom() *dataset.Enchantment {
...
func parseTemplateSacred(raw string) *dataset.Enchantment {
	const prefix = "{{Sacred"
	const suffix = "}}"
...
func parseTemplateShatter(rawShatterValue string) *dataset.Enchantment {
...
func parseTemplateSalt(raw string) *dataset.Enchantment {
	const prefix = "{{Salt"
	const suffix = "}}"
	...
	switch t {
	case "", "basic":
		return &dataset.Enchantment{Name: "Salt"}
	default:
...
func parseTemplateSetItemEnchantment(raw string) *dataset.Enchantment {
...
func parseTemplateShattermantle(raw string) *dataset.Enchantment {
...
func parseTemplateSealedInUndeath() *dataset.Enchantment {
...
func parseTemplateShockingBlow(raw string) *dataset.Enchantment {
...
func parseTemplateScorchingFlame(raw string) *dataset.Enchantment {
...
func parseTemplateScarabofProtectionWard() []*dataset.Enchantment {
...
func parseTemplateSecretDoorDetection() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSinkLikeaBrick() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateScallawagLuck(raw string) *dataset.Enchantment {
...
func parseTemplateShadowblade(raw string) *dataset.Enchantment {
...
func parseTemplateSkybreaker(raw string) *dataset.Enchantment {
...
func parseTemplateSirocco(raw string) *dataset.Enchantment {
...
func parseTemplateShieldedbyMoonlight() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateShieldBash(raw string) *dataset.Enchantment {
...
func parseTemplateSingleMindedness() *dataset.Enchantment {
	return &dataset.Enchantment{
