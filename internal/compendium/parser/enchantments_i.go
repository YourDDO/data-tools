...
func parseTemplateItemFeat(rawIFValue string) *dataset.Enchantment {
...
func parseTemplateItemSet(rawISValue string) *dataset.Enchantment {
...
// markers into a normalized []dataset.SetBonusOut. It returns the remaining
...
func parseTemplateImmune(rawImmuneValue string) *dataset.Enchantment {
	const prefix = "{{Immune|"
	const suffix = "}}"
...
func parseTemplateIncite(rawIncValue string, itemType string) []*dataset.Enchantment {
	const prefix = "{{Incite|"
	const suffix = "}}"
...
func parseTemplateIntercessionWard() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateInspireGreatnessExtra(raw string) *dataset.Enchantment {
...
func parseTemplateItemMaterialDR(raw string) *dataset.Enchantment {
...
func parseTemplateIce(raw string) *dataset.Enchantment {
	const prefix = "{{Ice"
	const suffix = "}}"
	...
	switch t {
	case "", "basic":
		return &dataset.Enchantment{Name: "Ice"}
	default:
...
func parseTemplateInvisibilityGuard(raw string) *dataset.Enchantment {
...
func parseTemplateIncinerationGuard(raw string) *dataset.Enchantment {
...
func parseTemplateIceBarrier(raw string) *dataset.Enchantment {
	name := "Ice Barrier"
	amount := "15"
...
func parseTemplateIceShardsGuard(raw string) *dataset.Enchantment {
...
func parseTemplateIncrediblePotential(raw string) *dataset.Enchantment {
...
func parseTemplateIncineration(raw string) *dataset.Enchantment {
...
func parseTemplateIdentityCrisis(raw string) *dataset.Enchantment {
...
func parseTemplateImpact(raw string) *dataset.Enchantment {
	const prefix = "{{Impact"
	const suffix = "}}"
...
func parseTemplateIriansMight() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Irian's Might",
...
func parseTemplateInflictBlight() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Inflict Blight",
...
func parseTemplateInspirationoftheInferno() *dataset.Enchantment {
	return &dataset.Enchantment{
