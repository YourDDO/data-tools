...
func TestParseTemplateConcealment(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: &dataset.Enchantment{Name: "Blurry", Amount: "20%"},
		},
		{
			name: "dusk is case insensitive",
			raw:  "{{Concealment|DUSK}}",
			want: &dataset.Enchantment{Name: "Dusk", Amount: "10%"},
		},
		{
			name: "lesser displacement without a space",
			raw:  "{{Concealment|LesserDisplacement}}",
			want: &dataset.Enchantment{Name: "Lesser Displacement", Amount: "25%"},
		},
		{
		...
		},
		{
			...
			want: &dataset.Enchantment{Name: "Smoke Screen", Amount: "20%"},
		},
		{
		...
		},
		{
			...
			want: &dataset.Enchantment{Name: "Concealment", Amount: "5%", BonusType: "Enhancement"},
		},
		{
			name: "custom negative penalty",
			raw:  "{{Concealment|Custom|-5|Quality}}",
			want: &dataset.Enchantment{Name: "Concealment", Amount: "-5%", BonusType: "Quality"},
		},
		{
			name: "custom title",
			raw:  "{{Concealment|Custom|5||Smoke Screen +5%}}",
			want: &dataset.Enchantment{Name: "Smoke Screen +5%", Amount: "5%", BonusType: "Enhancement"},
		},
		{
			name: "fixed type custom title",
			raw:  "{{Concealment|Dusk|||Twilight Shroud}}",
			want: &dataset.Enchantment{Name: "Twilight Shroud", Amount: "10%"},
		},
		{
