...
func parseTemplateAbility(rawAbilityValue string) *dataset.Enchantment {
...
func parseTemplateAC(rawACValue string) *dataset.Enchantment {
	const prefix = "{{AC|"
	const suffix = "}}"
	const defaultBonusType = "Enhancement" // Default from documentation
...
func parseTemplateActionBoostEnhancement(rawBoostValue string) *dataset.Enchantment {
	...
	if !strings.HasPrefix(rawBoostValue, prefix) || !strings.HasSuffix(rawBoostValue, suffix) {
		...
		if strings.TrimSpace(rawBoostValue) == "{{ActionBoostEnhancement}}" {
			...
			return &dataset.Enchantment{Name: baseName, Amount: "3", BonusType: "Enhancement"}
		}
		return nil
	}
...
func parseTemplateArmorPiercing(rawAPValue string) *dataset.Enchantment {
...
func parseTemplateAccuracy(rawAccValue string) *dataset.Enchantment {
...
func parseTemplateAnger(raw string) *dataset.Enchantment {
	const prefix = "{{Anger"
	const suffix = "}}"
	...
	if inner == "" { // no params
		return &dataset.Enchantment{Name: "Rage Charges", Amount: "3"}
	}
...
func parseTemplateAbilitySkills(rawASValue string) []*dataset.Enchantment {
...
func parseTemplateAssassination(rawAValue string) *dataset.Enchantment {
...
func parseTemplateAnthemMelody(rawAMValue string) *dataset.Enchantment {
...
func parseTemplateAlignmentDamage(raw string) *dataset.Enchantment {
...
func parseTemplateAlacrity(rawAlValue string) *dataset.Enchantment {
...
func parseTemplateArmorMastery(rawAMValue string) *dataset.Enchantment {
...
func parseTemplateAlignmentBypass(raw string) []*dataset.Enchantment {
	...
	makeEffect := func(al string) *dataset.Enchantment {
		return &dataset.Enchantment{Name: "Damage Reduction Bypass: " + al, Element: al}
	}
	...
	return []*dataset.Enchantment{makeEffect(aNorm)}
}
...
func parseTemplateAligned(raw string) *dataset.Enchantment {
	...
	if title != "" {
		return &dataset.Enchantment{Name: title}
	}

	a := strings.ToLower(strings.TrimSpace(alignment))
	switch a {
	case "evil":
		return &dataset.Enchantment{Name: "Taint of Evil"}
	case "good":
		return &dataset.Enchantment{Name: "Taint of Good"}
	case "law", "lawful":
		return &dataset.Enchantment{Name: "Taint of Law"}
	case "chaos", "chaotic":
		return &dataset.Enchantment{Name: "Taint of Chaos"}
	case "embodylaw", "embody law", "embody-law":
		return &dataset.Enchantment{Name: "Embodiment of Law"}
	case "embodychaos", "embody chaos", "embody-chaos":
		return &dataset.Enchantment{Name: "Embodiment of Chaos"}
	default:
		return nil
	}
}
...
func parseTemplateAlignmentAbsorb(raw string) *dataset.Enchantment {
...
func parseTemplateAttunedToHeroism(raw string) *dataset.Enchantment {
...
func parseTemplateAsh(raw string) *dataset.Enchantment {
	const prefix = "{{Ash"
	const suffix = "}}"
	s := strings.TrimSpace(raw)
	if !strings.HasPrefix(s, prefix) || !strings.HasSuffix(s, suffix) {
...
func parseTemplateArcaneCastingDexterity(raw string) *dataset.Enchantment {
...
// Usage: {{AcidCorrosion}}
func parseTemplateAcidCorrosion(raw string) *dataset.Enchantment {
...
// Template: Anthem
// Usage: {{Anthem|(Type)}}
func parseTemplateAnthem(raw string) *dataset.Enchantment {
	const prefix = "{{Anthem"
	const suffix = "}}"
	s := strings.TrimSpace(raw)
	if !strings.HasPrefix(s, prefix) || !strings.HasSuffix(s, suffix) {
...
func parseTemplateAlchemicalConservation(raw string) []*dataset.Enchantment {
...
func parseTemplateAlchemicalElementalAttuned(raw string) *dataset.Enchantment {
...
func parseTemplateAgainstTheSlaveLordsSetBonus() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateAxeblock(raw string) *dataset.Enchantment {
...
func parseTemplateArcaneAugmentation(raw string) *dataset.Enchantment {
...
// Usage: {{AngelicGrace}}
func parseTemplateAngelicGrace(raw string) *dataset.Enchantment {
...
func parseTemplateAntimagicSpike(raw string) *dataset.Enchantment {
...
func parseTemplateAirGuard(raw string) *dataset.Enchantment {
...
func parseTemplateAlmostThere() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Almost There",
...
func parseTemplateAutoRepair(raw string) *dataset.Enchantment {
...
func parseTemplateAnchoring() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Anchoring",
...
func parseTemplateAdditionalDamageType(raw string) *dataset.Enchantment {
...
func parseTemplateAbilityDamage(raw string) *dataset.Enchantment {
...
func parseTemplateAlchemical(raw string) *dataset.Enchantment {
...
func parseTemplateAccursedFlame(raw string) *dataset.Enchantment {
...
func parseTemplateAntiMagicRunes(raw string) *dataset.Enchantment {
...
func parseTemplateAvalanche(raw string) *dataset.Enchantment {
...
func parseTemplateArrowSpitting() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Arrow Spitting",
...
func parseTemplateAmmunition(fullTemplate string) *dataset.Enchantment {
