...
func parseTemplateClickie(rawClickieValue string) *dataset.Enchantment {
...
func parseTemplateConcealment(rawConcValue string) *dataset.Enchantment {
...
func parseTemplateCrippling(rawCripValue string) *dataset.Enchantment {
...
func parseTemplateCarryingCapacity(rawCCValue string) *dataset.Enchantment {
...
func parseTemplateColorText(raw string) *dataset.Enchantment {
...
func parseTemplateCommand(raw string) []*dataset.Enchantment {
...
func parseTemplateCrushingWaveGuard(raw string) *dataset.Enchantment {
...
func parseTemplateCrystalCoveUpgrade(raw string) *dataset.Enchantment {
...
func parseTemplateCacophonicGuard(raw string) *dataset.Enchantment {
...
func parseTemplateCannithCombatInfusion() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateConfoundingEnchantment() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateChaoticCurse() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Chaotic Curse",
...
func parseTemplateChaosGuard() []*dataset.Enchantment {
	return []*dataset.Enchantment{
		{
			Name:      "Armor Class",
			Amount:    "2",
...
func parseTemplateCeruleanWave(raw string) *dataset.Enchantment {
...
func parseTemplateCCHatUpgrades(raw string) []*dataset.Enchantment {
...
func parseTemplateCraftableRuneArm(raw string) *dataset.Enchantment {
...
func parseTemplateCurseVector(raw string) *dataset.Enchantment {
...
func parseTemplateCrimsonCovenant(raw string) *dataset.Enchantment {
...
func parseTemplateConstrictingNightmare(raw string) *dataset.Enchantment {
...
func parseTemplateCorrosiveSaltGuard(raw string) *dataset.Enchantment {
...
func parseTemplateCursedMaelstrom(raw string) *dataset.Enchantment {
...
func parseTemplateCompletedWeapon(raw string) *dataset.Enchantment {
...
func parseTemplateCrushingWave(raw string) *dataset.Enchantment {
...
func parseTemplateCloudburst(raw string) *dataset.Enchantment {
...
func parseTemplateCursespewing(raw string) *dataset.Enchantment {
...
func parseTemplateCleverStrike(raw string) *dataset.Enchantment {
...
func parseTemplateCripplingFlames(raw string) *dataset.Enchantment {
...
func parseTemplateCoronach() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Coronach",
...
func parseTemplateCasterLevel(fullTemplate string) []*dataset.Enchantment {
