...
func parseTemplateTurnDice(rawTurnDiceValue string) *dataset.Enchantment {
...
func parseTemplateTemperanceOfBelief() *dataset.Enchantment {
...
func parseTemplateTendonSlice(rawTSValue string) *dataset.Enchantment {
...
func parseTemplateThornGuard(rawTGValue string) *dataset.Enchantment {
...
func parseTemplateTemperanceOfSpirit() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateTheArtbladesGift() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateTheWarbladesWrath() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateTaintOfShavarath(raw string) *dataset.Enchantment {
	const (
...
func parseTemplateTouchoftheMournlands(raw string) *dataset.Enchantment {
...
// Template: Turning
// Usage: {{Turning|(Type)}}
func parseTemplateTurning(raw string) *dataset.Enchantment {
...
// Usage: {{TempestStorm}}
func parseTemplateTempestStorm(raw string) *dataset.Enchantment {
...
// Template: Trembling
// Usage: {{Trembling}}
func parseTemplateTrembling(raw string) *dataset.Enchantment {
...
func parseTemplateTraceOfMadness(raw string) *dataset.Enchantment {
...
func parseTemplateTouchOfImmortality(raw string) []*dataset.Enchantment {
...
func parseTemplateTelekinesisGuard(raw string) *dataset.Enchantment {
...
func parseTemplateTheGoldenCurse(raw string) *dataset.Enchantment {
...
func parseTemplateTetZik(raw string) *dataset.Enchantment {
...
func parseTemplateTemporarySpellPoints(raw string) *dataset.Enchantment {
...
func parseTemplateTransmutedPlatinum(raw string) *dataset.Enchantment {
...
func parseTemplateTrapTheSoul(raw string) *dataset.Enchantment {
...
func parseTemplateThunderstruck(raw string) *dataset.Enchantment {
...
func parseTemplateTransformKineticEnergy(raw string) *dataset.Enchantment {
...
func parseTemplateThornOfTheRose(raw string) *dataset.Enchantment {
...
func parseTemplateThunderforged(raw string) *dataset.Enchantment {
...
func parseTemplateThornyCrownofMadness(raw string) *dataset.Enchantment {
...
func parseTemplateTheDraggingOfTheDepths(raw string) *dataset.Enchantment {
...
func parseTemplateTheReaver(raw string) *dataset.Enchantment {
...
func parseTemplateTelekinetic(raw string) *dataset.Enchantment {
...
func parseTemplateTheMoralCompass(raw string) *dataset.Enchantment {
...
func parseTemplateThaarakCorrosion(raw string) *dataset.Enchantment {
...
func parseTemplateTheFallingStar() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateThrilloftheHunt() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateThunderbane() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Thunderbane",
...
func parseTemplateTurbulentBurst() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateTouchedbyWildMagic(raw string) *dataset.Enchantment {
	return &dataset.Enchantment{
