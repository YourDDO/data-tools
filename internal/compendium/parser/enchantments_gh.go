...
func parseTemplateGuardbreaking(rawGuardValue string) *dataset.Enchantment {
...
func parseTemplateGoodluck(rawLuckValue string) []*dataset.Enchantment {
...
func parseTemplateGhostly(rawGhostValue string) []*dataset.Enchantment {
...
func parseTemplateHealLikeaGolem(raw string) *dataset.Enchantment {
...
func parseTemplateHitPointGuard() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateHeroism(raw string) []*dataset.Enchantment {
	// {{Heroism|(Style)}}
...
// Template: GhostTouch
// Usage: {{GhostTouch}}
func parseTemplateGhostTouch(raw string) *dataset.Enchantment {
...
func parseTemplateGuidanceofShar(raw string) *dataset.Enchantment {
...
func parseTemplateHeroicInspiration(raw string) *dataset.Enchantment {
...
// Template: HolySmite
// Usage: {{HolySmite}}
func parseTemplateHolySmite(raw string) *dataset.Enchantment {
...
// Usage: {{HealersBounty}}
func parseTemplateHealersBounty(raw string) *dataset.Enchantment {
...
// Usage: {{GlacialFrost}}
func parseTemplateGlacialFrost(raw string) *dataset.Enchantment {
...
func parseTemplateGuard(raw string) *dataset.Enchantment {
	const prefix = "{{Guard"
	const suffix = "}}"
	s := strings.TrimSpace(raw)
	if !strings.HasPrefix(s, prefix) || !strings.HasSuffix(s, suffix) {
...
// Template: HasteGuard
// Usage: {{HasteGuard}}
func parseTemplateHasteGuard(raw string) *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Haste Guard",
...
func parseTemplateHallowed(raw string) *dataset.Enchantment {
...
func parseTemplateGreaterDispellingGuard() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateHalcyonMind() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Halcyon Mind",
...
func parseTemplateGlassJawStrike() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateHiddenHandSecretVisibility(raw string) *dataset.Enchantment {
...
func parseTemplateHammerblock(raw string) *dataset.Enchantment {
...
func parseTemplateGhostbane(raw string) *dataset.Enchantment {
...
func parseTemplateGoldcurse(raw string) *dataset.Enchantment {
...
func parseTemplateHeartseeker(raw string) *dataset.Enchantment {
...
func parseTemplateGiantSlayer(raw string) *dataset.Enchantment {
...
func parseTemplateGreaterDispelling(raw string) *dataset.Enchantment {
...
func parseTemplateGodlyWrath(raw string) *dataset.Enchantment {
