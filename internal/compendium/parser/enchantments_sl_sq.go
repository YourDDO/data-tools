...
func parseTemplateSpellFocus(rawFocusValue string) []*dataset.Enchantment {
...
func parseTemplateSpellPower(rawPowerValue string) []*dataset.Enchantment {
...
func parseTemplateSpellPoints(rawSPValue string) *dataset.Enchantment {
...
func parseTemplateSpellLore(rawLoreValue string) []*dataset.Enchantment {
...
func parseTemplateSpellAugmentation(raw string) *dataset.Enchantment {
...
func parseTemplateSpellSchoolSave(rawSaveValue string) []*dataset.Enchantment {
...
func parseTemplateSpeed(rawSpeedValue string) []*dataset.Enchantment {
	const prefix = "{{Speed|"
	const suffix = "}}"
	...
	if !strings.HasPrefix(rawSpeedValue, prefix) || !strings.HasSuffix(rawSpeedValue, suffix) {
		...
		if strings.TrimSpace(rawSpeedValue) == "{{Speed}}" {
			return []*dataset.Enchantment{{Name: "Speed"}}
		}
		return nil
	}
...
func parseTemplateSpellPenetration(rawSPValue string) *dataset.Enchantment {
...
func parseTemplateSoundproof() *dataset.Enchantment {
...
func parseTemplateTheMummysGift() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSpellResistance(rawSRValue string) *dataset.Enchantment {
...
func parseTemplateSparkscale() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name: "Sparkscale",
	}
}

func parseTemplateSpellCritDamage(rawSCDValue string) []*dataset.Enchantment {
...
func parseTemplateSpellIntensity(raw string) []*dataset.Enchantment {
	...
	enchantments := make([]*dataset.Enchantment, 0, len(powers))
...
//   - No Title override.
func parseTemplateSneakAttackDamage(raw string) *dataset.Enchantment {
...
func parseTemplateSpellPowerGuard() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSneakAttackDice(raw string) *dataset.Enchantment {
...
func parseTemplateSlayLiving(raw string) *dataset.Enchantment {
...
// Usage: {{SpellTurmoil}}
func parseTemplateSpellTurmoil(raw string) *dataset.Enchantment {
...
func parseTemplateSpellAbsorption(raw string) *dataset.Enchantment {
...
func parseTemplateSneakAttack(raw string) []*dataset.Enchantment {
...
func parseTemplateSpellResonance(raw string) *dataset.Enchantment {
...
func parseTemplateSpearblock(raw string) *dataset.Enchantment {
...
func parseTemplateSonic(raw string) *dataset.Enchantment {
...
func parseTemplateSlaveLordsBlank(raw string) []*dataset.Enchantment {
...
func parseTemplateSpikeGuard() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Spike Guard",
...
func parseTemplateSpikeStudded() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Spike-Studded",
...
func parseTemplateSoulOfElements(raw string) *dataset.Enchantment {
...
func parseTemplateSolarGuard(raw string) *dataset.Enchantment {
...
func parseTemplateSmiting(raw string) *dataset.Enchantment {
...
func parseTemplateSlowburst(raw string) *dataset.Enchantment {
...
func parseTemplateSlicingWinds(raw string) *dataset.Enchantment {
...
func parseTemplateSoulTear(raw string) *dataset.Enchantment {
...
func parseTemplateSoulEating(raw string) *dataset.Enchantment {
