...
func parseTemplateFortification(rawFortValue string) *dataset.Enchantment {
...
func parseTemplateFalseLife(rawFLValue string) *dataset.Enchantment {
	...
	if !strings.HasPrefix(rawFLValue, prefix) || !strings.HasSuffix(rawFLValue, suffix) {
		...
		if strings.TrimSpace(rawFLValue) == "{{FalseLife}}" {
			return &dataset.Enchantment{Name: "False Life"}
		}
		return nil
	}
...
func parseTemplateFeatherFalling(rawFFValue string) *dataset.Enchantment {
...
func parseTemplateFavoredWeapon() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Favored Weapon",
...
func parseTemplateFrozenAether() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Frozen Aether",
...
func parseTemplateFellingTheOak() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateFaith() []*dataset.Enchantment {
	return []*dataset.Enchantment{
		{
...
func parseTemplateFreezingIce(rawFIValue string) *dataset.Enchantment {
...
func parseTemplateFiligreeItemEnchantment(raw string) *dataset.Enchantment {
...
// Template: ForceBlast
// Usage: {{ForceBlast}}
func parseTemplateForceBlast(raw string) *dataset.Enchantment {
...
func parseTemplateFlamescale(raw string) []*dataset.Enchantment {
...
func parseTemplateFreedomOfMovement(raw string) *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateFireShield(raw string) *dataset.Enchantment {
...
func parseTemplateFlawedShadowscaleArmor(raw string) *dataset.Enchantment {
...
func parseTemplateFromTheShadows(raw string) *dataset.Enchantment {
...
func parseTemplateFreezingIceGuard(raw string) *dataset.Enchantment {
...
func parseTemplateFleshmaker(raw string) *dataset.Enchantment {
...
func parseTemplateFearsome() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Fearsome",
...
func parseTemplateFeedsOffMadness() *dataset.Enchantment {
...
func parseTemplateFrostbite() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Frostbite",
...
func parseTemplateFaeryfireCurse(raw string) []*dataset.Enchantment {
...
func parseTemplateFascinationGuard(raw string) *dataset.Enchantment {
...
func parseTemplateFettersofUnreality(raw string) *dataset.Enchantment {
...
func parseTemplateFinesse(raw string) *dataset.Enchantment {
...
func parseTemplateFinishingTouch(raw string) *dataset.Enchantment {
...
func parseTemplateFusible(raw string) *dataset.Enchantment {
...
func parseTemplateFragmented(raw string) *dataset.Enchantment {
...
func parseTemplateFracturing(raw string) *dataset.Enchantment {
...
func parseTemplateFlamebitten(raw string) *dataset.Enchantment {
...
func parseTemplateFeeding(raw string) *dataset.Enchantment {
...
func parseTemplateForgedLightning() *dataset.Enchantment {
	return &dataset.Enchantment{
