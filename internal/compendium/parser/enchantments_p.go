...
func parseTemplatePactDice(rawPDValue string) *dataset.Enchantment {
...
func parseTemplateParrying(rawPValue string) []*dataset.Enchantment {
...
func parseTemplateProficiency(rawProfValue string) *dataset.Enchantment {
...
func parseTemplatePermanantEffect(rawPEValue string) *dataset.Enchantment {
...
func parseTemplateProofAgainstDisease(rawPDValue string) []*dataset.Enchantment {
...
func parseTemplateParalyzing(raw string) *dataset.Enchantment {
...
func parseTemplateProtectionFromEvil(raw string) []*dataset.Enchantment {
	// {{ProtectionFromEvil}}
...
// Template: PowerDrain
// Usage: {{PowerDrain}}
func parseTemplatePowerDrain(raw string) *dataset.Enchantment {
...
func parseTemplatePoisonGuard(raw string) *dataset.Enchantment {
...
func parseTemplatePowerStore(raw string) *dataset.Enchantment {
...
func parseTemplatePoison(raw string) *dataset.Enchantment {
	const prefix = "{{Poison"
	const suffix = "}}"
...
func parseTemplatePuncturing(raw string) *dataset.Enchantment {
...
func parseTemplatePlanarConflux(raw string) *dataset.Enchantment {
...
func parseTemplatePolycurse(raw string) *dataset.Enchantment {
...
func parseTemplatePlanarSearing(raw string) *dataset.Enchantment {
...
func parseTemplatePlantSlaying(raw string) *dataset.Enchantment {
...
func parseTemplatePathoftheGuardingStone(raw string) *dataset.Enchantment {
...
func parseTemplatePealsOfThunder() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateParagonWeapon() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Paragon Weapon",
...
func parseTemplatePickaCard() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Pick a Card",
