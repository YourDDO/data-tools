...
func parseTemplateStunning(rawStunValue string) []*dataset.Enchantment {
...
func parseTemplateSteam(raw string) *dataset.Enchantment {
	const prefix = "{{Steam"
	const suffix = "}}"
	...
	switch t {
	case "", "basic":
		return &dataset.Enchantment{Name: "Steam"}
	default:
...
func parseTemplateStriding(raw string) *dataset.Enchantment {
...
func parseTemplateSuppressed() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateStormreaverUpgrade(raw string) *dataset.Enchantment {
...
func parseTemplateSuppressMadness(raw string) *dataset.Enchantment {
...
func parseTemplateStaggeringBlow(raw string) *dataset.Enchantment {
...
func parseTemplateSymbioticFlexibility() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSymbioticBacklash() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSwimLikeAFish() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateSunAndStars() *dataset.Enchantment {
	name := "Sun and Stars"
...
func parseTemplateStonePrisonGuard(raw string) *dataset.Enchantment {
...
func parseTemplateSubtleTarget() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Subtle Target",
...
func parseTemplateStickyGooGuard() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateStormreaverThunderclap() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateStability(raw string) *dataset.Enchantment {
...
func parseTemplateStumbling(raw string) *dataset.Enchantment {
...
func parseTemplateSundering(raw string) *dataset.Enchantment {
...
func parseTemplateStealerOfSouls(raw string) *dataset.Enchantment {
...
func parseTemplateStonePrison(raw string) *dataset.Enchantment {
...
func parseTemplateSunBurst(raw string) *dataset.Enchantment {
...
func parseTemplateStaticAttraction(raw string) *dataset.Enchantment {
...
func parseTemplateStonePaws() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Stone Paws",
