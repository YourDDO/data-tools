...
func parseTemplateRuneArmImbue(rawImbueValue string) *dataset.Enchantment {
...
func parseTemplateReturning(rawRetValue string) *dataset.Enchantment {
...
func parseTemplateRevelInBlood(rawRBValue string) *dataset.Enchantment {
...
func parseTemplateRuneArmRechargeRate(raw string) *dataset.Enchantment {
...
func parseTemplateReinforcedFists(rawRFValue string) *dataset.Enchantment {
...
func parseTemplateResistance(rawResValue string) []*dataset.Enchantment {
...
func parseTemplateRadiance(raw string) *dataset.Enchantment {
...
func parseTemplateRelentlessFury() *dataset.Enchantment {
...
func parseTemplateRegeneration(raw string) *dataset.Enchantment {
...
func parseTemplateRiposte(raw string) []*dataset.Enchantment {
...
func parseTemplateQuellingStrikes(raw string) *dataset.Enchantment {
...
func parseTemplateRunicRevitalization(raw string) *dataset.Enchantment {
...
func parseTemplateQuoriMindShield(raw string) []*dataset.Enchantment {
...
func parseTemplateRaging(raw string) *dataset.Enchantment {
	const prefix = "{{Raging|"
	s := strings.TrimSpace(raw)
...
// Template: Quenched
// Usage: {{Quenched}}
func parseTemplateQuenched(raw string) *dataset.Enchantment {
...
func parseTemplateRadianceGuard(raw string) *dataset.Enchantment {
...
func parseTemplateRagingInferno(raw string) *dataset.Enchantment {
...
func parseTemplateReaping(raw string) *dataset.Enchantment {
...
func parseTemplateRepairSystems() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Repair Systems",
...
func parseTemplateRighteous(raw string) *dataset.Enchantment {
...
func parseTemplateRadiantBlast(raw string) *dataset.Enchantment {
...
func parseTemplateRockslide() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Rockslide",
...
func parseTemplateRockShattering() *dataset.Enchantment {
	return &dataset.Enchantment{
...
func parseTemplateRebellion() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Rebellion",
...
func parseTemplateRibcracker(raw string) *dataset.Enchantment {
