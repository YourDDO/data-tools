...
func parseTemplateElementalAbsorb(rawAbsorbValue string) []*dataset.Enchantment {
	...
	results := make([]*dataset.Enchantment, 0, len(elements))
...
func parseTemplateElementalResistance(rawResistanceValue string) *dataset.Enchantment {
...
func parseTemplateEnhancementBonus(rawBonusValue string, itemType string) []*dataset.Enchantment {
	...
	var enchantments []*dataset.Enchantment // Use slice of pointers
...
func parseTemplateEnhancedKi(rawEKValue string) *dataset.Enchantment {
...
func parseTemplateEfficientMetamagic(rawEMValue string) *dataset.Enchantment {
...
func parseTemplateEversight(rawEValue string) []*dataset.Enchantment {
...
func parseTemplateEldritchBlastDice(rawEBDValue string) *dataset.Enchantment {
...
func parseTemplateElementalDOT(rawDOTValue string) *dataset.Enchantment {
...
func parseTemplateElementalAOE(rawAOEValue string) *dataset.Enchantment {
...
func parseTemplateElasticity() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Elasticity",
...
func parseTemplateElementalArrow(rawEAValue string) *dataset.Enchantment {
...
func parseTemplateElemental(rawElValue string) *dataset.Enchantment {
...
// Template: Ethereal
// Usage: {{Ethereal}}
func parseTemplateEthereal(raw string) *dataset.Enchantment {
...
func parseTemplateExtraSongs(raw string) []*dataset.Enchantment {
...
func parseTemplateExtraSmites(raw string) []*dataset.Enchantment {
...
func parseTemplateEternalHolyBurst(raw string) *dataset.Enchantment {
...
func parseTemplateEpicNecropolisItemUpgrade(raw string) []*dataset.Enchantment {
...
func parseTemplateEarthenGuard(raw string) *dataset.Enchantment {
...
func parseTemplateEternalFaith(raw string) []*dataset.Enchantment {
...
func parseTemplateEmbraceoftheSpiderQueen(raw string) *dataset.Enchantment {
...
func parseTemplateEarthgrabGuard(raw string) *dataset.Enchantment {
...
func parseTemplateElementalEnergy(raw string) *dataset.Enchantment {
...
func parseTemplateEchoesof2006() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Echoes of 2006",
...
func parseTemplateExtraLayOnHands(raw string) *dataset.Enchantment {
...
func parseTemplateEidolonSummons(raw string) *dataset.Enchantment {
...
func parseTemplateElementalAttuned(raw string) *dataset.Enchantment {
...
func parseTemplateEnergySiphon(raw string) *dataset.Enchantment {
...
func parseTemplateEnfeebling(raw string) *dataset.Enchantment {
...
func parseTemplateEchoesOfAngdrelve(raw string) *dataset.Enchantment {
...
func parseTemplateElementalSpiral(raw string) *dataset.Enchantment {
...
func parseTemplateEntangling(raw string) *dataset.Enchantment {
...
func parseTemplateEarthgrab() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Earthgrab",
...
func parseTemplateElementalForm(raw string) *dataset.Enchantment {
...
func parseTemplateEnervation() *dataset.Enchantment {
	return &dataset.Enchantment{
		Name:  "Enervation",
